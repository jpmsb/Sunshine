        ...
        <li v-for="session in connectedSessions" :key="session.session_id" class="list-group-item">
          <div class="d-flex flex-wrap align-items-center gap-2">
            <div class="flex-grow-1">
              <div>{{ sessionDisplayName(session) }}</div>
